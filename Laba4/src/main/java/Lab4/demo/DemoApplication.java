...
public class DemoApplication {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("4 differen letters count = " + ForDifferentLetters(str));
        EightLetterSequenses(str);
        ForWords(a);
        a = Clear();
    ...
    public static void EightLetterSequenses(String str) {
        String[] words = str.split("\\s+");
    ...
    public static int ForDifferentLetters(String str) {
        String[] words = str.split("\\s+");
